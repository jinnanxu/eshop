...
public class ServerUploadUtil {
	...
	public static String uploadToServer(String fileName,File file) {
...
//		File file = new File("D:/tmp/20191018084616.jpg");
//		ServerUploadUtil.uploadToServer(file.getName(), file);
		String str = "{\"errno\":0,\"url\":\"http://118.25.89.125:18080/images/20210516150856shf73.jpg\"}";
