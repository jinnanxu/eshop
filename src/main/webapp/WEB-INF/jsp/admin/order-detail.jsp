...
<section class="Hui-article-box">
	...
	<div class="Hui-article">
		<article class="cl pd-20" style="width:80%;">
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-3 text-r">订单号：</label>
				<div class="formControls col-xs-8 col-sm-9">${vo.order.orderCode }
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-3 text-r">预订时间：</label>
				<div class="formControls col-xs-8 col-sm-9"><fmt:formatDate value="${vo.order.orderTime}" pattern="yyyy-MM-dd HH:mm"/>
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-3 text-r">订单总额：</label>
			...
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-3 text-r">订单状态：</label>
			...
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-3 text-r">收货人：</label>
				<div class="formControls col-xs-8 col-sm-9">${vo.order.receiveName }
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-3 text-r">收货地址：</label>
				<div class="formControls col-xs-8 col-sm-9">${vo.order.fullAddress }
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-3 text-r">手机号：</label>
				<div class="formControls col-xs-8 col-sm-9">${vo.order.mobile }
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-3 text-r">订单备注：</label>
				<div class="formControls col-xs-8 col-sm-9">${vo.order.remark }
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-3 text-r">商品列表：</label>
				<div class="formControls col-xs-8 col-sm-9">
