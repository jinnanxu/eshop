...
<section class="Hui-article-box">
	...
	<div class="Hui-article">
		...
		<form action="updateExp" method="post" class="form form-horizontal">
			<div class="row cl">
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" placeholder="请输入最新物流信息" id="" name="expText">
				</div>
			</div>
			<div class="row cl">
				<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-3">
					<a class="btn btn-warning radius" type="submit" href="javascript: window.history.go(-1);">&nbsp;&nbsp;返回&nbsp;&nbsp;</a>
