...
<section class="Hui-article-box">
	...
	<div class="Hui-article">
		...
		<form action="updateProfile" method="post" class="form form-horizontal" id="updateForm">
			<div class="row cl">
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="password" class="input-text" value="${admin.pwd }" name="pwd">
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-3">上次登录：</label>
				<div class="formControls col-xs-8 col-sm-9">
					<fmt:formatDate value="${admin.lastLogin}" pattern="yyyy-MM-dd HH:mm"/>
				</div>
			</div>
