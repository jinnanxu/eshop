...
<div class="header">电脑配件在线商城后台管理系统</div>
<div class="loginWraper">
	<div id="loginform" class="loginBox">
		<h3 class="text-c c-white">管理员登录</h3>
		<form action="/mall/admin/login-form" method="post" class="form form-horizontal" id="loginForm">
			<div class="row cl">
...
<div class="footer">Copyright 电脑配件在线商城后台管理系统</div>
