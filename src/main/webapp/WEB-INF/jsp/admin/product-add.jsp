...
<section class="Hui-article-box">
	...
	<div class="Hui-article">
		...
		<form action="saveProduct" method="post" class="form form-horizontal" onsubmit="return getEditor();" enctype="multipart/form-data">
			<div class="row cl">
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" value="" placeholder="" name="subTitle">
				</div>
			</div>
			<div class="row cl">
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" value="" placeholder="" name="quantity">
				</div>
			</div>
			<!-- <div class="row cl">
