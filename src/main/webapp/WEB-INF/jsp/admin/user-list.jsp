...
<section class="Hui-article-box">
	...
	<div class="Hui-article">
		<article class="cl pd-20 container" style="padding-top: 0; width: 65%;">
			<div class="mt-20">
						...
						<c:forEach items="${page.records }" var="r" varStatus="row">
							<tr>
								...
								<%-- <td>
									...
									<a href="/mall/admin/blockUser?uid=${r.userId }"><button class="btn btn-warning size-S"><i class="Hui-iconfont" style="color: #fff;">&#xe60e;</i>&nbsp;禁止上传</button></a>
									</c:if>
									<c:if test="${r.status eq 0 }">
									<a href="/mall/admin/unblockUser?uid=${r.userId }"><button class="btn btn-success size-S"><i class="Hui-iconfont" style="color: #fff;">&#xe605;</i>&nbsp;允许上传</button></a>
									</c:if>
									<a href="#" onclick="delcfm(${r.userId});"><button class="btn btn-danger size-S" type="submit"><i class="Hui-iconfont" style="color: #fff;">&#xe6e2;</i>&nbsp;删除</button></a>
								</td> --%>
							</tr>
						</c:forEach>
					</tbody>
